 ...
 const handleChange = (e) => {
  ...
  const handleAddMember = () => {
    if (memberSelect && !form.members.some(m => m.policeId === memberSelect)) {
      setForm({
        ...form,
        members: [...form.members, { policeId: memberSelect, role:'member' }]
      });
      setMemberSelect('');
    }
  };
  ...
  const resetForm = () => {
    setForm({
      ...
      deploymentAddress: '', fireArms: 'N/A', comDevices: '', patrolBodyNumber: '',
  ...
  return (
    <Box p={2}>
      <Paper sx={{ p: 2, mb: 3 }}>
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}  gutterBottom>BICYCLE DEPLOYMENT MANAGEMENT</Typography>
